# terraform-aws-ecs-alarm-scheduled
...
| <a name="input_alarm_priority"></a> [alarm\_priority](#input\_alarm\_priority) | Priority of the alarm | `string` | `"high"` | no |
...
| <a name="input_threshold"></a> [threshold](#input\_threshold) | Required percentage of successful requests | `number` | `0` | no |
